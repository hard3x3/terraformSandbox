...
function randomDream() {
	...
	var zoneColors_0 = "#000000".replace(/0/g,function(){return (~~(Math.random()*16)).toString(16);});
	var zoneColors_1 = "#000000".replace(/0/g,function(){return (~~(Math.random()*16)).toString(16);});
	var zoneColors_2 = "#000000".replace(/0/g,function(){return (~~(Math.random()*16)).toString(16);});
	var zoneColors_3 = "#000000".replace(/0/g,function(){return (~~(Math.random()*16)).toString(16);});
	...
	callDream(antenna, status, resourceLvl, seed, zColors, canvas_, char, font, fontSize, placement, aColors)
}
...
function configDream(){
	...
	var canvas = document.getElementsByClassName("canvas")[0].value;
	const canvas_ = canvas.slice(1, -1).split(',').map(item => item.trim());
	const c0 = document.getElementsByClassName("charset")[0];
	const c1 = document.getElementsByClassName("charset")[1];
	const c2 = document.getElementsByClassName("charset")[2];
	const c3 = document.getElementsByClassName("charset")[3];

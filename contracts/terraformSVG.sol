...
contract TerraformSVG is Ownable {
    ...
    /// @notice Struct for passing dream info from terraformSandbox to this contract
    struct SVGParams {
    ...
    /// @param colors the color scheme of the dream's zone
        ...
        returns (string memory)
    {
        ...
        // Plague dreams have background animations
    ...
    /// @param activation the dream's activation
    /// @param colors the color scheme of the dream's zone
    /// @param altColors_ alt colors of a Plague dream
    /// @return a string representing a style on a class selector
    function setKeyframes(
        Activation activation, 
        string[10] memory colors, 
        string[2] memory altColors_
    ) 
        internal 
        pure 
        returns (string memory)
    {
        // Plague dreams' backgrounds alternate between two colors
    ...
    /// @notice generates Javascript for inclusion in animated dreams
    /// @param p is a SVGParams struct passed from terraformSandbox
        ...
        returns (string memory) 
    {
        return string(
            abi.encodePacked(
                ...
                ";let DIRECTION=",
                ToString.toString(uint(resourceDirection())),
                ";const SEED=",
                ToString.toString(p.seed),
                jsString
            )
        );
    }

    /// @notice Determines the direction of a dreams' resource animation
